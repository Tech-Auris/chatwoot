...
// The contact toggle moved into the conversation header (MoreActions).
// The Alt+O keyboard shortcut is kept here so the muscle memory still
// works even though the button is no longer painted on this floating pill.
