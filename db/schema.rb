...
ActiveRecord::Schema[7.1].define(version: 2026_09_24_210500) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.boolean "campaigns_live_chat_menu_enabled", default: false, null: false
  ...
  create_table "campaigns", force: :cascade do |t|
    ...
    t.integer "cadence_seconds", default: 10, null: false
    t.string "conversation_label"
    t.string "audience_file_name"
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id", "origem"], name: "index_conversations_on_account_id_and_origem"
  ...
  create_table "sales_quotes", force: :cascade do |t|
    ...
    t.datetime "token_card_waived_at"
    t.boolean "api_integration_waived", default: false, null: false
    ...
    t.datetime "boleto_enabled_at"
    t.integer "waivers_amount", default: 0, null: false
  ...
  create_table "teams", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "auto_assign_include_offline", default: false, null: false
